...
public class UnitOfMeasure
{
    ...
    private UnitOfMeasure(Guid id, string title, State state)
    {
        Id = id;
        Title = title;
        State = state;
    ...
    public static UnitOfMeasure Create(Guid id, string title, State state)
    {
        if(id == Guid.Empty)
        ...
        return new UnitOfMeasure(id, title, state);
    }
